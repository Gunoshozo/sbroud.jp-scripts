export default {
    urls: Object.create({
        ...
        routedGameChapterConfig: "assets/games/{gameName}/routes/{routeName}/chapters.config.json.gz",
        nonRoutedGameChapterConfig: "assets/games/{gameName}/chapters/chapters.config.json.gz",
        routedChapterFile: "assets/games/{gameName}/routes/{routeName}/{file}",
        nonRoutedChapterFile: "assets/games/{gameName}/chapters/{file}",
        tips: "assets/games/{gameName}/tips.json.gz",
